package com.anggitprayogo.mvp.modules.home.adapter;
...
public class CakeAdapter extends RecyclerView.Adapter<CakeAdapter.Holder>{
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.textview_preview_description)protected TextView mCakeDescription;
    ...
    public void addCakes(List<Cake> cake){
        mCakeList.addAll(cake);
